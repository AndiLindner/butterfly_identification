...
#MODEL=max_vit_tiny
#MODEL="maxvit_t"
#MODEL_PATH="$RESULTS_DIR/maxvit_t_10341785.bin"
#MODEL="convnext_large"
#MODEL_PATH="$RESULTS_DIR/convnext_large_10572172.bin"
#MODEL="efficientnet_v2_l"
#MODEL_PATH="$RESULTS_DIR/efficientnet_v2_l/10482630_2025-04-24_08-12/pytorch_model.bin"

# Training parameters
BATCH_SIZE=8  # Batch size *per GPU*
EPOCHS=250
BASE_LR=0.002  # Scales linearly with devices in code
WEIGHT_DECAY=0
